...
**Generator Ensemble**: 9 heterogeneous models (GPT-4o, Claude Opus, Gemini, DeepSeek, Llama, Mistral, O1-mini) run in parallel to generate diverse assessments with reasoning traces. Temperature set to `0.0` for deterministic output.
